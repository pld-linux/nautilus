...
Source0:	http://ftp.gnome.org/pub/gnome/sources/nautilus/2.19/%{name}-%{version}.tar.bz2
# Source0-md5:	0fe63741bbd8052ee0329b3312a2724c
...
BuildRequires:	gnome-vfs2-devel >= 2.19.3
